...
public class displayWorkersScreen extends JFrame {
	...
	public displayWorkersScreen() {
		...
		displayWorkersTable.getTableHeader().setReorderingAllowed(false);
		displayWorkersTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		displayWorkersTable.setRowSelectionAllowed(true);
