...
class Service{
    ...
    public Service(){
        try {
           ...
           ////.println("Veritabanina Baglanmada Problem "+ e.getMessage());
        }
    ...
    public ArrayList<Project> getAllProjects(ArrayList<Employee> allEmployeees){
        ...
        try {
            ...
            ResultSet projectsData = s.executeQuery(queryProjects);
             ...
             while(projectsData.next()){
                ...
                while (works_onData.next()) {
                    String employeeid = works_onData.getString("identification_no");
           ...
           // //.println("projeleri alirken hata "+e.getMessage());
        }
        return null;
   ...
   public void AddEmployeetoDatabase(Employee employee){
        ...
        if(employee instanceof Designer){
            ...
            try {       
                ...
                try (PreparedStatement preparedStatement = conn.prepareStatement(queryaddWorkson)) {
                    ...
                    ////.println("worksona eklerken hata "+ e.getMessage());
                  
                }
            } catch (Exception e) {
              // //.println("employee eklerken hata"+e.getMessage());
    ...
    public void setProjectActive(Project project){
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(query)){
            ...
            //.println("hata olustu "+e.getMessage());
        }
    ...
    public void setAnotherProjectToEmployee(Employee e,Project project){
        ...
        String query2 = "UPDATE works_on SET project_id = ? WHERE identification_no = ?";
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(query)){
            ...
            if(e instanceof Analyst){
                ...
                try (PreparedStatement preparedStatement2 = conn.prepareStatement(query2)) {
                    ...
                    //.println("Güncellenen satır sayısı: " + rowsAffected);
                } catch (SQLException exxcc) {
                    //.println("hata works_onda employee silmeye calisirken " +exxcc.getMessage());
                }
            ...
            try (PreparedStatement preparedStatement = conn.prepareStatement(query)) {
                ...
                if (resultSet.next()) {           
                    ...
                    try (PreparedStatement preparedStatement2 = conn.prepareStatement(query3)) {
                         ...
                         // //.println("Manageri projeye set ederken hata olustu "+exc.getMessage());
               ...
               // //.println("analist sayisini almaya calisirkern hata" + exc.getMessage());
                // Hata durumunda uygun şekilde işleyin
            }
            ...
            try (PreparedStatement preparedStatement = conn.prepareStatement(query)) {
                ...
                if (resultSet.next()) {           
                    ...
                    try (PreparedStatement preparedStatement2 = conn.prepareStatement(query3)) {
                         ...
                         // //.println("hata olustu "+exc.getMessage());
    ...
    private void setManagerOfTheProjectToDatabase(Manager m){
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(query)) {
           ...
           // //.println("Manageri projeye set ederken hata olustu "+e.getMessage());
           /// e.printStackTrace();
            // Hata durumunda uygun şekilde işleyin
        }
    }
    ...
    private void deleteEmpfromWorksOn(String empId){
        try {
            String deleteQuery = "DELETE FROM works_on WHERE identification_no = ?";
